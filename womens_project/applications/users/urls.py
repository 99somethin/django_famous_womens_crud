...
urlpatterns = [
    ...
    path('password-reset/', PasswordResetView.as_view(template_name='users/password_resert_form.html',
                                                      email_template_name='users/password_resert_email.html',
    ...
    path('password-reset/complete/',  # Corrected the typo here
